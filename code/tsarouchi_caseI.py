...
if __name__ == "__main__":
    ...
    for iter in range(0, num_iter, 1):
        ...
        for i in range(num_tasks):
            ...
            if (p[0][i] <= (human_c1)) and (p[1][i] <= (human_c2)) and (p[1][i] > robot_c2): #only the human is capable of this task
            ...
            elif (p[0][i] > (human_c1)) and (p[0][i] <= robot_c1) and (p[1][i] <= robot_c2): #only the robot is capable of this task
            ...
            elif (p[0][i] > (robot_c1)) or (p[1][i] > human_c2) or ((p[0][i] > human_c1) and (p[1][i] > robot_c2)): #no agent is capable
        ...
        res_mat_file_name = "results/tsarouchi/tsarouchi_caseI_eta50_" + str(iter) + ".mat"
